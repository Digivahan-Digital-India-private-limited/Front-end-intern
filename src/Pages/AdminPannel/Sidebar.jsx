...
const menuItems = [
  ...
  { name: "Customer Queries", icon: MessageSquare, link: "" },
  { name: "Reviews", icon: Star, link: "" },
  { name: "Issues / Priority", icon: AlertTriangle, link: "" },
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-2">
          {menuItems.map((item, index) => (
            <Link
              to={item.link}
              key={index}
              className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition"
            >
        ...
        <div className="px-3 py-4 border-t">
          <button className="flex items-center gap-3 w-full px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition">
