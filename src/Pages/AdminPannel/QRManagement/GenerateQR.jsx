...
import { QrCode, Download, Printer, Car, Bike, CheckCircle2, Loader2, Zap, ArrowRight, Plus } from "lucide-react";

/* ─── helpers ────────────────────────────────────────────────── */
const QR_TYPES = [
  { value: "CAR",  label: "Car",  icon: Car,  gradient: "from-blue-500 to-blue-600",  bg: "bg-blue-50",  text: "text-blue-600",  border: "border-blue-200"  },
  { value: "BIKE", label: "Bike", icon: Bike, gradient: "from-emerald-500 to-emerald-600", bg: "bg-emerald-50", text: "text-emerald-600", border: "border-emerald-200" },
];
...
export default function GenerateQR() {
  ...
  const handleGenerate = () => {
    ...
    setLoading(true); setDone(false); setGenerated([]); canvasRefs.current = [];
    setTimeout(() => {
      setGenerated(Array.from({ length: quantity }, (_, i) => buildQRValue(qrType, i)));
  ...
  const handleDownload = () => {
    canvasRefs.current.forEach((canvas, i) => {
      ...
      link.download = `${qrType}_QR_${String(i + 1).padStart(4, "0")}.png`;
      link.click();
    });
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="slide-up mb-6">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-500">Generate QR codes for vehicle management</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl card-shadow p-6 slide-up" style={{ animationDelay: "0.1s" }}>
              ...
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Select Vehicle Type</h3>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {QR_TYPES.map((type) => {
                    ...
                    return (
                      <button
                        key={type.value}
                        onClick={() => { setQrType(type.value); setDone(false); setGenerated([]); }}
                        className={`
                      ...
                      >
                        <div className="text-center">
                          ...
                          `}>
                            <VehicleIcon className={`w-6 h-6 ${active ? 'text-white' : type.text}`} />
                          </div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setQuantity(v); setDone(false); setGenerated([]);
                    }}
              ...
              <button
                ...
                className={`
                  ...
                  ${!qrType || loading
                    ...
                    : "bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
                  }
                `}
              >
                {loading ? (
                  ...
                  <>
                    ...
                    Generate {quantity} {qrType || "QR"} Code{quantity > 1 ? "s" : ""}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800">
                        {generated.length} {qrType} QR Code{generated.length > 1 ? "s" : ""} Generated!
                      </h4>
              ...
              >
                ...
                Download {isReady ? generated.length : ""} QR Code{quantity > 1 ? "s" : ""} (PNG)
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl card-shadow p-6 slide-up" style={{ animationDelay: "0.2s" }}>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Quick Stats</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Selected Type</span>
                  <span className="font-medium text-gray-900">{qrType || "None"}</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-green-600">{generated.length}</span>
                </div>
              </div>
            </div>

            {/* Features */}
            <div className="bg-white rounded-xl card-shadow p-6 slide-up" style={{ animationDelay: "0.3s" }}>
